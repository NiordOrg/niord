    ...
    <#if coords?has_content && coords?size % 2 == 0>
        ...
        <table>
            <#list fromCoords as fromCoord>
                <tr>
                    <!-- From position -->
                    <td nowrap align="right" style="width: 0.8cm">${fromCoord.index})</td>
                    <td nowrap align="right" style="width: 2.3cm"><@formatPos lat=fromCoord.coordinates[1] format=format /></td>
                    <td nowrap align="right" style="width: 2.3cm"><@formatPos lon=fromCoord.coordinates[0] format=format /></td>
                    <#if fromName>
                    ...
                    <td nowrap align="right" style="width: 0.8cm"><#if toCoord?has_content>${toCoord.index})</#if></td>
