 ...
 * <p>
 * This class contains the S-124 Dataset Identification Information so that it
...
public class S124DatasetInfo {
     ...
     * @param atonNodes The S-125 Dataset AtoN nodes
     */
    public S124DatasetInfo(String datasetId, String agency, List<Message> message) {
        ...
        this.language = "en";
        this.abstractText = "Autogenerated S-124 Dataset for" + Optional.ofNullable(message)
