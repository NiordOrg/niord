...
class S124DatasetInfo {
    ...
    public S124DatasetInfo(String datasetId, String agency, String organization, List<Message> message) {
        ...
        this.agency = agency;
        // The S-100 GML profile fixes this value, so it has to be spelled exactly like this
        ...
        // S-100 Part 17 clause 17-4.3 names a dataset file 124<producerCode><unique>.GML. Part 10b Table 10b-4
        // defines datasetFileIdentifier as the name of the file the dataset is packaged in, not as a title.
        this.fileIdentifier = String.format("124%s%s.GML", S124Identifiers.PRODUCER_CODE, S124Identifiers.toFileNameToken(this.datasetId));
        this.title = "Niord S-124 Dataset";
        // Niord generates English only. datasetLanguage is of XSD type ISO-639-2 (pattern \w{3}), so the two letter
        // code "en" is not valid here.
        this.language = "eng";
